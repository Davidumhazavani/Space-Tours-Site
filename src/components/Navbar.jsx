  ...
  return (
    ...
    >
      <img
        ...
        alt=""
      />
      <div className="hidden bg-[rgb(225,225,225,4%)] p-8 md:flex text-white gap-5">
      <NavLink to={"/"} className={({isActive})=> isActive? 'border-b-2 border-white' : 'flex items-center gap-2'}>
              <b className="md:hidden barlow-condensed-medium">00</b> <p>Home</p>
            </NavLink>
            <NavLink to={"/destination"} className={({isActive})=> isActive? 'border-b-2 border-white' : 'flex items-center gap-2'}>
              <b className="md:hidden barlow-condensed-medium">01</b> <p>Destination</p>
            </NavLink>
            <NavLink to={"crew"} className={({isActive})=> isActive? 'border-b-2 border-white' : 'flex items-center gap-2'}>
              <b className="md:hidden barlow-condensed-medium">02</b> <p>Crew</p>
            </NavLink>
            <NavLink to={"Technology"} className={({isActive})=> isActive? 'border-b-2 border-white' : 'flex items-center gap-2'}>
              <b className="md:hidden barlow-condensed-medium">03</b> <p>Technology</p>
            </NavLink>
      </div>
